...
public class MoscowWeatherForecastFeatureTest {
    ...
    На сайте сказано, что должен выводится прогноз на 7 дней, но при проверке успешны только первые 3 значения date,
    а остальные = null и тест не проходит. Это происходит потому,
     что выводится полный прогноз на весь текущий день и два следующих, а не на 7
